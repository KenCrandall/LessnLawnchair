...
<div id="stats_body">
  <p>
  	...
  	You have shortened <strong><?php echo number_format($number_lessnd); ?></strong> URLs for <strong><?php echo number_format($number_redirected) ?></strong> redirects to date.
  </p>
  <h2>Today</h2>
